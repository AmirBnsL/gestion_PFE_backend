...
var getUser = function (req, res) {
    var userRepository = datasource_1.AppDataSource.getRepository('User');
};
exports.getUser = getUser;
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepository, hashedPassword, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userRepository = datasource_1.AppDataSource.getRepository('User');
                return [4 /*yield*/, userRepository.existsBy({ email: req.body.email })];
            case 1:
                if (_a.sent()) {
            ...
            case 3:
                ...
                user = userRepository.create({ firstname: req.body.firstname, lastname: req.body.lastname, email: req.body.email, passwordHash: hashedPassword });
